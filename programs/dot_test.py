...
for column in range(8):
	device.scroll_down(redraw=True)
	time.sleep(1)

device.show_message("0",font=proportional(CP437_FONT))
time.sleep(3)
for column in range(8) :
	device.scroll_up(redraw=True)
	time.sleep(1)

device.show_message("1",font=proportional(CP437_FONT))
time.sleep(3)
