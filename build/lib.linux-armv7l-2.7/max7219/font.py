...
CP437_FONT = [
    ...
    [0x10, 0x42, 0x18, 0x3D, 0xBC, 0x18, 0x42, 0x08],  # '0'
    [0x24, 0x00, 0x99, 0x3C, 0x3C, 0x99, 0x00, 0x24],  # '1'
    [0x62, 0x73, 0x59, 0x49, 0x6F, 0x66, 0x00, 0x00],  # '2'
    [0x22, 0x63, 0x49, 0x49, 0x7F, 0x36, 0x00, 0x00],  # '3'
    [0x06, 0x0E, 0x0C, 0x04, 0x20, 0x70, 0x70, 0x20],  # '4'
    [0xC4, 0x86, 0x8F, 0x0F, 0x0E, 0xC4, 0xE0, 0xE0],  # '5'
    [0x10, 0x38, 0x3C, 0x3C, 0x38, 0x30, 0x10, 0x00],  # '6'
    ...
    [0x0E, 0xE0, 0x07, 0x70, 0x03, 0xE0, 0x07, 0x70],  # 'A'
    [0x1C, 0xC1, 0x0E, 0xE0, 0x06, 0xC1, 0x0E, 0xE0],  # 'B'
    [0x38, 0x83, 0x1C, 0xC1, 0x0C, 0x83, 0x1C, 0xC1],  # 'C'
    [0x70, 0x07, 0x38, 0x83, 0x18, 0x07, 0x38, 0x83],  # 'D'
    [0xE0, 0x0E, 0x70, 0x07, 0x30, 0x0E, 0x70, 0x07],  # 'E'
    [0xC1, 0x1C, 0xE0, 0x0E, 0x60, 0x1C, 0xE0, 0x0E],  # 'F'
    [0x83, 0x38, 0xC1, 0x1C, 0xC0, 0x38, 0xC1, 0x1C],  # 'G'
    [0x07, 0x70, 0x83, 0x38, 0x81, 0x70, 0x83, 0x38],  # 'H'
    [0x41, 0x1C, 0x81, 0x14, 0x41, 0x1C, 0x41, 0x14],  # 'I'
    [0x82, 0x38, 0x03, 0x28, 0x82, 0x38, 0x82, 0x28],  # 'J'
    [0x05, 0x70, 0x06, 0x50, 0x05, 0x70, 0x05, 0x50],  # 'K'
    [0x0A, 0xE0, 0x0C, 0xA0, 0x0A, 0xE0, 0x0A, 0xA0],  # 'L'
    [0x14, 0xC1, 0x18, 0x41, 0x14, 0xC1, 0x14, 0x41],  # 'M'
    [0x28, 0x83, 0x30, 0x82, 0x28, 0x83, 0x28, 0x82],  # 'N'
    [0x50, 0x07, 0x60, 0x05, 0x50, 0x07, 0x50, 0x05],  # 'O'
    [0xA0, 0x0E, 0xA0, 0x0A, 0xA0, 0x0E, 0xA0, 0x0A],  # 'P'
    [0x11, 0x44, 0x11, 0x44, 0x11, 0x44, 0x11, 0x44],  # 'Q'
    [0x22, 0x88, 0x22, 0x88, 0x22, 0x88, 0x22, 0x88],  # 'R'
    [0x44, 0x11, 0x44, 0x11, 0x44, 0x11, 0x44, 0x11],  # 'S'
    [0x88, 0x22, 0x88, 0x22, 0x88, 0x22, 0x88, 0x22],  # 'T'
    [0x11, 0x00, 0x55, 0x00, 0xAA, 0x00, 0x55, 0x00],  # 'U'
    [0x00, 0xAA, 0x00, 0x55, 0x00, 0xAA, 0x00, 0x55],  # 'V'
    [0x55, 0x00, 0xAA, 0x00, 0x55, 0x00, 0xAA, 0x00],  # 'W'
    [0x00, 0x55, 0x00, 0xAA, 0x00, 0x55, 0x00, 0xAA],  # 'X'
...
SINCLAIR_FONT = [
    ...
    [0xFF, 0x04, 0x08, 0x08, 0x04, 0x7E, 0x00, 0x00],  # 'M'
...
LCD_FONT = [
    ...
    [0xF0, 0x02, 0x0c, 0x02, 0x7f, 0x00, 0x00, 0x00],  # 'M'
